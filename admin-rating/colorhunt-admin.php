...
if (isset($_POST['delete_review_id'])) {
   ...
   //delete from color hunt
   $query_delete_color_hunt = "DELETE FROM color_hunt WHERE review_id = :review_id";
   $statement_color_hunt = $connect->prepare($query_delete_colorhunt);
   $statement_color_hunt->execute(array(':review_id' => $delete_review_id));
}
...
$query_reviews_color_hunt = "SELECT * FROM color_hunt ORDER BY review_id DESC";
$result_reviews_color_hunt = $connect->query($query_reviews_color_hunt, PDO::FETCH_ASSOC);
         ...
         <div class="rating-header">
            <div class="rating-content">
               <div class="relative overflow-x-auto">
                  <h1 class="text-white">Total Ratings in Khorma: <?php echo $total_ratings_color_hunt; ?></h1>
                  <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                     ...
                     <tbody>
                        <?php while ($row = $result_reviews_color_hunt->fetch()): ?>
