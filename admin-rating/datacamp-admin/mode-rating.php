...
if (isset($_POST['delete_review_id'])) {
    ...
    // Delete from MYSQL 
    $query_delete_mongo_db = "DELETE FROM mysql WHERE review_id = :review_id";
    $statement_mongo_db = $connect->prepare($query_delete_mongo_db);
    $statement_mongo_db->execute(array(':review_id' => $delete_review_id));

      // Delete from mode 
      $query_delete_mode = "DELETE FROM mode WHERE review_id = :review_id";
      $statement_mode = $connect->prepare($query_delete_mode);
      $statement_mode->execute(array(':review_id' => $delete_review_id));
...
//mysql
$query_reviews_mongo_db = "SELECT * FROM mongo_db ORDER BY review_id DESC";
$result_reviews_mongo_db = $connect->query($query_reviews_mongo_db, PDO::FETCH_ASSOC);

$query_reviews_mode = "SELECT * FROM mongo_db ORDER BY review_id DESC";
$result_reviews_mode = $connect->query($query_reviews_mode, PDO::FETCH_ASSOC);
            ...
            <div class="rating-header">
                <div class="rating-content">
                    <div class="relative overflow-x-auto">
                        <H1>Total Ratings in Mode: <?php echo $total_ratings_mode; ?></H1>
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                <?php while ($row = $result_reviews_mode->fetch()): ?>
