...
if(isset($_POST["rating_data"], $_POST["user_name"], $_POST["user_review"])) {
    ...
    $query = "INSERT INTO tailwind_components (user_name, user_review, user_rating, datetime) VALUES (:user_name, :user_review, :user_rating, NOW())";
...
if(isset($_POST["action"]))
{
    ...
    $query = "
    SELECT * FROM tailwind_components
