    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white">Introducing Gitea</h1>
                <p class="text-gray-600 dark:text-gray-300">  With Gitea, teams and developers can seamlessly create and manage repositories based on Git, enabling streamlined collaboration and code management processes. </p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/gitea.png" alt="">
        ...
        <div class="tools-description-header">
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> Experience the power of Gitea and unlock new levels of efficiency and collaboration in your development process. Whether you're a small team or a large enterprise, Gitea empowers you to deliver high-quality software faster and more reliably than ever before.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Code Hosting: </span> Gitea enables the creation and management of repositories based on git. It also makes Code Review never so easy and convinent which enhanced code quality for users and businesses</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Projects: </span> You can efficiently manages requirements, features and bugs through issue tasks, labeling and kanban boards. These tools help plan and track the progress of your development by incorporating branches, tags, milestones, assignments, time tracking and dependencies.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">CI/CD: </span> Gitea features an integrated CI/CD system, Gitea Actions, that is compatible with GitHub Actions. Users can create workflows using the familiar YAML format or utilize over 20K existing plugins.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Packages: </span> Gitea supports more than 20 different kinds of public or private package management, including: Cargo, Chef, Composer, Conan, Conda, Container, Helm, Maven, NPM, NuGet, Pub, PyPI, RubyGems, Vagrant, etc.</p>
            </div>
        </div>
    </section>
