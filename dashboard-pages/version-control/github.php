    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white">Introducing Github</h1>
                <p class="text-gray-600 dark:text-gray-300"> it's a thriving ecosystem where developers come together to build, collaborate, and innovate. With powerful tools and AI-driven features, GitHub empowers developers to bring their ideas to life and create groundbreaking software that shapes the future. </p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/github.png" alt="">
                <a href="https://about.gitea.com" target="_blank">
        ...
        <div class="tools-description-header">
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300">  GitHub offers everything you need to build, collaborate, and innovate with confidence. Join the millions of developers who rely on GitHub to power their projects and accelerate their development journey. </p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Collaborative Development: </span>  GitHub provides a collaborative environment where developers can work together on projects of any size and complexity. From small open-source initiatives to large-scale enterprise applications, GitHub enables seamless collaboration and teamwork across teams and organizations.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Version Control: </span>  At the heart of GitHub is Git, the industry-standard version control system that enables developers to track changes to their codebase, revert to previous versions, and collaborate with others efficiently. With GitHub's intuitive interface and powerful branching workflows, managing code changes has never been easier.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">AI-powered Features: </span> GitHub leverages the power of artificial intelligence to enhance the developer experience and streamline common tasks. From code suggestions and automatic code formatting to intelligent code reviews and issue triaging, GitHub's AI-powered features help developers write better code faster.</p> 
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Open Source Ecosystem: </span>  GitHub is a hub for open source software, hosting millions of projects and repositories across a wide range of technologies and domains. Developers can contribute to existing projects, share their own creations, and collaborate with others to build software that makes a difference.</p>
            </div>
        </div>
    </section>
