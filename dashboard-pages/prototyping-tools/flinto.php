    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white">Introducing Flinto</h1>
                <p class="text-gray-600 dark:text-gray-300"> it's a powerful tool trusted by top designers worldwide to bring their app designs to life with interactive and animated prototypes. Here's why Flinto stands out as the go-to choice for designers</p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/flinto.png" alt="">
                <a href="https://www.flinto.com" target="_blank">
        ...
        <div class="tools-description-header">
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> Whether you're designing mobile apps, websites, or other digital products, Flinto empowers you to create stunning interactive prototypes that bring your designs to life in ways that static mockups simply can't match. Join the ranks of top designers worldwide and elevate your design workflow with Flinto today.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Intuitive Interface: </span> With Flinto, creating prototypes is a breeze thanks to its user-friendly interface and intuitive design tools. Whether you're a seasoned designer or just starting out, Flinto makes it easy to bring your ideas to life with minimal effort.</p>
            </div> 
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Interactive Prototyping: </span> Take your designs to the next level with Flinto's interactive prototyping capabilities. Add touch gestures, transitions, and animations to your prototypes to create realistic and engaging user experiences that truly showcase your vision.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Real-time Preview:  </span> With Flinto's real-time preview feature, you can see your prototypes come to life instantly as you make changes, allowing you to iterate quickly and fine-tune your designs with ease.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Device Preview:  </span> Test your prototypes on different devices and screen sizes with Flinto's built-in device preview feature. Ensure that your designs look and feel great across various platforms and devices, from desktop computers to smartphones and tablets.</p>
            </div>
        </div>
    </section>
