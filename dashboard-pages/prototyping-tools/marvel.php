    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white">Introducing Marvel</h1>
                <p class="text-gray-600 dark:text-gray-300"> it's a comprehensive platform that empowers modern design teams to rapidly prototype, test, and hand off digital products with ease. </p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/marvel.png" alt="">
        ...
        <div class="tools-description-header">
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300">  Marvel provides everything you need to bring your ideas to life and transform how you create digital products with your team. Empower your team members, streamline your design process, and unleash your creativity with Marvel today.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Rapid Prototyping:  </span>  With Marvel's intuitive design tools and drag-and-drop interface, creating interactive prototypes is quick and effortless. Whether you're designing a mobile app, website, or other digital product, Marvel allows you to prototype your ideas with speed and precision.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Testing Capabilities: </span> Marvel's built-in testing features enable you to gather feedback and validate your designs with real users. Conduct usability tests, gather insights, and iterate on your designs based on user feedback, ensuring that your products meet the needs and expectations of your target audience.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Design System Management:  </span>  Keep your designs consistent and scalable with Marvel's design system management tools. Create reusable components, define design guidelines, and maintain a single source of truth for your team's design assets, streamlining your workflow and ensuring consistency across all your projects.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Version Control: </span>   Stay organized and track changes with Marvel's version control features. Access previous versions of your designs, compare revisions, and revert to earlier iterations if needed, giving you peace of mind and confidence as you iterate on your designs.</p>
            </div>
        </div>
    </section>
