    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white">Introducing Protopie</h1>
                <p class="text-gray-600 dark:text-gray-300"> it's an advanced solution trusted by designers worldwide for creating dynamic and multimodal interactions that push the boundaries of user experience design. </p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/proto-piee.png" alt="">
        ...
        <div class="tools-description-header">
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> Whether you're designing mobile apps, web experiences, or IoT devices, ProtoPie empowers you to create interactive prototypes that push the boundaries of what's possible in user experience design. Elevate your design workflow and bring your ideas to life with ProtoPie today.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Dynamic Interactions: </span> With ProtoPie, you can go beyond static screen-to-screen transitions and create dynamic interactions that mimic real-world behavior. From scrolling and swiping to dragging and dropping, ProtoPie empowers you to design interactions that feel natural and intuitive to users.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Multimodal Prototyping: </span> : Explore new frontiers of user experience design with ProtoPie's support for multimodal interactions. Whether you're designing for touch, voice, gesture, or sensor input, ProtoPie enables you to create immersive experiences that engage users on multiple levels.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">No Code Required: </span> Say goodbye to complex coding and scripting languages. With ProtoPie's intuitive interface and visual editor, you can create sophisticated interactions and animations using simple drag-and-drop gestures, making prototyping accessible to designers of all skill levels.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Pixel-Perfect Design: </span>  ProtoPie's precise control over animations and interactions allows you to achieve pixel-perfect designs that closely match your vision. Fine-tune timing, easing curves, and other parameters to ensure that your prototypes look and feel just right.</p>
            </div>
        </div>
    </section>
