    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white">Introducing Freehand by Invision</h1>
                <p class="text-gray-600 dark:text-gray-300"> the all-in-one collaborative workspace that empowers your team to ideate, plan, execute, and track projects seamlessly. Here's why Freehand is the ultimate tool for unlocking your team's full potential</p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/invision.png" alt="">
        ...
        <div class="tools-description-header">
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> Unlock your team's full potential with Freehand by InVision. Experience the power of collaborative ideation, flexible planning, streamlined execution, and seamless integration—all in one intuitive workspace. Sign up for Freehand today and transform the way your team works together.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Collaborative Ideation:</span> With Freehand, brainstorming and ideation become dynamic and collaborative experiences. Bring your team together in a virtual workspace where everyone can contribute ideas, sketches, and concepts in real-time, fostering creativity and innovation.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Flexible Planning: </span> Plan and organize your projects effortlessly within Freehand's versatile workspace. Whether you're mapping out user journeys, creating wireframes, or outlining project timelines, Freehand provides the flexibility and freedom to visualize your ideas and plans exactly as you envision them.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Streamlined Execution: </span> Execute your projects with precision and efficiency using Freehand's intuitive tools and features. From annotating designs to providing feedback and approvals, Freehand streamlines the execution process, ensuring everyone is aligned and on the same page every step of the way.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Track Progress: </span> Keep your projects on track and monitor progress in real-time with Freehand's built-in tracking and collaboration features. From assigning tasks to tracking milestones and deadlines, Freehand empowers you to stay organized and focused, even as projects evolve and deadlines approach.</p>
            </div>
        </div>
    </section>
