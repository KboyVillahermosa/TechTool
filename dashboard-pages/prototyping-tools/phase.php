    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white">Introducing Phase</h1>
                <p class="text-gray-600 dark:text-gray-300">  With Phase, designing and prototyping websites and apps has never been more intuitive. Our new product is reworked for the digital age, empowering designers and developers to bring their ideas to life with unprecedented ease and flexibility.</p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/phase.png" alt="">
        ...
        <div class="tools-description-header">
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> Design and prototype websites and apps intuitively with Phase—the reinvention of digital design. Empower your creativity, streamline your workflow, and bring your ideas to life with Phase today.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Intuitive Interface: </span> Phase features an intuitive and user-friendly interface designed to streamline your design workflow. With simple drag-and-drop functionality and intuitive navigation, you can create stunning websites and apps without any technical expertise.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Innovative Tools: </span>  Say goodbye to complex design tools and hello to Phase's innovative features. From powerful layout grids to customizable components and interactive animations, Phase offers everything you need to bring your creative vision to life with ease.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Responsive Design:  </span>  Design websites and apps that look great on any device with Phase's responsive design capabilities. Preview your designs across desktop, tablet, and mobile screens, and fine-tune your layouts to ensure a seamless and consistent user experience across all platforms.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Advanced Prototyping:  </span>  Create interactive prototypes with ease using Phase's advanced prototyping tools. Add gestures, transitions, and animations to your designs to create immersive user experiences that engage and delight users.</p>
            </div>
        </div>
    </section>
