    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white">Introducing Framer</h1>
                <p class="text-gray-600 dark:text-gray-300"> it's a powerful platform where teams collaborate to design and publish stunning websites that captivate audiences and drive results. Here's why Framer is the ultimate choice for teams seeking to elevate their web design process</p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/framer.png" alt="">
        ...
        <div class="tools-description-header">
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> Framer empowers you to create stunning websites that stand out from the crowd. Elevate your web design process, collaborate more effectively, and unleash your creativity with Framer today.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Intuitive Design Environment: </span> With Framer's intuitive design environment, creating beautiful websites is a breeze. Whether you're a seasoned designer or just starting out, Framer's user-friendly interface and powerful features make it easy to bring your ideas to life with pixel-perfect precision.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Collaborative Workflow:  </span> Framer fosters collaboration among team members, allowing designers, developers, and stakeholders to work together seamlessly in real-time. From brainstorming and ideation to prototyping and iteration, Framer streamlines the entire design process, ensuring that everyone is aligned and on the same page.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Interactive Prototyping:  </span> Take your website prototypes to the next level with Framer's interactive prototyping capabilities. Add advanced animations, transitions, and interactions to your designs to create immersive user experiences that engage and delight audiences.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Publishing and Sharing: </span> Once your website is ready, easily publish it to the web with Framer's built-in publishing tools. Share your designs with clients, stakeholders, and the world, and gather feedback in real-time to iterate and improve your website until it's perfect.</p>
            </div>
        </div>
    </section>
