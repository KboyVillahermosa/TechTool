...
<body class="bg-white dark:bg-gray-800">
    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white"> Introducing Tailwind CSS Components</h1>
                <p class="text-gray-600 dark:text-gray-300"> your ultimate resource for discovering a vast collection of free Tailwind CSS components and snippets contributed by the community. </p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/tailwind-components.png" alt="">
        ...
        <div class="tools-description-header">
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> Are you a web developer or designer looking to streamline your workflow and enhance your projects with Tailwind CSS? Look no further than Tailwind CSS Components, where you'll find a treasure trove of ready-made components and snippets to kickstart your next project.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Community Collaboration: </span> Tailwind CSS Components is powered by contributions from a vibrant community of developers and designers. Benefit from the collective knowledge and creativity of like-minded individuals who share their expertise and creations to help you succeed.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Comprehensive Collection: </span> Explore a comprehensive collection of free Tailwind CSS components and snippets, covering a wide range of UI elements, layouts, and functionality. From buttons and forms to navigation bars and modals, Tailwind CSS Components has everything you need to build beautiful and responsive interfaces.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Easy Integration: </span> Seamlessly integrate Tailwind CSS Components into your projects with simple copy-and-paste functionality. Each component comes with clear documentation and usage instructions, making it easy to incorporate into your codebase and customize to fit your design requirements.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Time-Saving: </span> Say goodbye to reinventing the wheel and spending hours coding UI elements from scratch. With Tailwind CSS Components, you can save valuable time and effort by leveraging pre-designed components that are ready to use out of the box, allowing you to focus on what matters most – bringing your ideas to life.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Quality Assurance: </span> Rest assured that each component featured on Tailwind CSS Components has been vetted for quality and usability. Whether you're a seasoned developer or just starting out, you can trust that you're getting reliable and well-designed components that meet industry standards and best practices.</p>
            </div>
        </div>
    </section>
   ...
   <section>
    ...
    <script src="../../dashboard-pages/dashboard-js/tailwind_compo_rating.js"></script>
</body>
