...
<body class="bg-white dark:bg-gray-800">
    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white"> Introducing Tailwind Cheat</h1>
                <p class="text-gray-600 dark:text-gray-300"> your ultimate companion for mastering Tailwind CSS and accelerating your web development workflow. Here's why the Tailwind CSS Cheat Sheet is an indispensable resource for developers and designers alike</p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/tailwind-cheat.png" alt="">
        ...
        <div class="tools-description-header">
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> Whether you're building a simple website or a complex web application, the Tailwind CSS Cheat Sheet is your go-to resource for harnessing the full power of Tailwind CSS. Explore the endless possibilities, streamline your development process, and bring your ideas to life with confidence. Start mastering Tailwind CSS today with the Tailwind CSS Cheat Sheet by your side.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Comprehensive Reference: </span> The Tailwind CSS Cheat Sheet provides a comprehensive reference of all utility classes and components available in the framework. Whether you're a beginner or an experienced user, you'll find everything you need to know about Tailwind CSS at your fingertips.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Effortless Navigation: </span> Say goodbye to endless searching and scrolling through documentation. The Tailwind CSS Cheat Sheet offers a neatly organized layout that makes it easy to quickly find the utility class or component you're looking for, saving you valuable time and effort.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Instant Access: </span> Access the Tailwind CSS Cheat Sheet anytime, anywhere, right from your browser. With its online format, you can quickly reference it whenever you need to look up a class or component, whether you're working on your desktop or mobile device.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">User-Friendly Interface: </span> The Tailwind CSS Cheat Sheet features a user-friendly interface that's easy to navigate and understand. Each utility class and component is clearly labeled and accompanied by examples and usage guidelines, making it simple to grasp and apply in your projects.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Updated Content: </span> Rest assured that the Tailwind CSS Cheat Sheet is regularly updated to reflect the latest changes and additions to the framework. You can trust that you're getting accurate and up-to-date information to support your development efforts.</p>
            </div>
        </div>
    </section>
                            ...
                            <div class="rate-header p-4">
                                <div class="rate-content">
                                    <div class="containers">
                                        <h1 class="mt-5 mb-5">Review & Rating in Tailwind Cheat</h1>
                                        <div class="card">
                                            
                                            <div class="card-header text-xl font-semibold text-gray-900 dark:text-white">Ratings</div>
                                            <div class="card-body">
                                                <div class="row">
    ...
    <script src="../../dashboard-pages/dashboard-js/tailwindcheat-rating.js"></script>
</body>
